...
void si5351_write_xfer(uint8_t, uint8_t *, int);
void si5351_read_xfer(uint8_t, uint8_t *, int);
void si5351_write_byte(uint8_t, uint8_t);
uint8_t si5351_read_byte(uint8_t);

#define SI5351_WRITE_XFER   si5351_write_xfer   /* reg, datap, count */
#define SI5351_READ_XFER    si5351_read_xfer    /* reg, datap, count */
#define SI5351_WRITE_BYTE   si5351_write_byte   /* reg, val */
